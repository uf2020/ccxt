...
- `market.apiKey / market['apiKey'] / $market->apiKey`: This is your public API key string literal ([see below](https://github.com/kroitor/ccxt/wiki/Manual#api-keys-setup)). Most markets require this for trading.

- `market.secret / market['secret'] / $market->secret`: Your private secret API key string literal ([see below](https://github.com/kroitor/ccxt/wiki/Manual#api-keys-setup)). Most markets require this as well together with the apiKey.
